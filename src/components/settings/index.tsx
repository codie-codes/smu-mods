...
const ToggleWebsiteTheme = dynamic(async () => {
...
export const settings: setting[] = [
    ...
    },
    {
        ...
        description: "Get the latest module list from the server. This is to ensure that you have the latest modules and their information",
    ...
    },
    {
        ...
        description: "If you are facing issues with the application, you can reset the data stored in the application. This will remove all your Planner and Timetable data",
