...
export const modules: ModuleBank = {
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "ESPENA DARLENE MACHELL DE LEON",
        },
        location: {
          building: "SOSS/CIS",
          room: "Seminar Room 3-3",
  ...
  IS211: {
    ...
    moduleCode: "IS211",
    exam: {
      dateTime: new Date("2024-12-05T16:00:00.000Z"),
      durationInHour: 3,
    },
    description:
