...
export const modules: ModuleBank = {
  ...
  "COR-COMM1304": {
    ...
    sections: [
      ...
      },
      {
        code: "G13",
        professor: {
          name: "GWENDOLINE ANNE LIM SIU KIAO",
        },
        location: {
          building: "LKCSB",
          room: "Seminar Room 2-8",
  ...
  "COR-XXXX20": {
    ...
    description:
      "This course discusses the challenges and opportunities of cosmopolitanism in Singapore, focusing on social cohesion and global identity.",
    sections: [],
    credit: 1,
    terms: ["Term 1"],
  },
  ...
  COR3301: {
    ...
    terms: ["Term 1", "Term 2"],
    exam: {
      dateTime: new Date("2025-11-28T06:30:00.000Z"),
      durationInHour: 2,
    },
  },
  IS114: {
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "FIONA CLARE WILLIAMSON, SONNY ROSENTHAL, TERRY VAN GEVELT",
        },
        location: {
          building: "SOSS/CIS",
          room: "Seminar Room 3-3",
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "BENJAMIN LEE, HE JIANZHONG",
        },
        location: {
          building: "SMUC",
          room: "Active Learning CR 3-1",
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "TANG HONG WEE, MUHAMMED AMEER S/O MOHAMED NOOR, AMELIA CHUA, CHNG SHUQI",
        },
        location: {
          building: "SOA",
          room: "Seminar Room 3-1",
  ...
  OBHR101: {
    ...
    moduleCode: "OBHR101",
    description:
      "This course focuses on managing people in the workplace. Students learn theoretical and conceptual foundations for understanding people, groups, and organizations, and practical tools for accomplishing personal, group, and organizational objectives with a long term view to creating a sustainable and ethical environment for the individual to thrive and flourish. Topics include leadership, work motivation, individual differences, work values, attitudes, emotions, decision making, organizational culture, organizational change, among others.",
    credit: 1,
    terms: ["Term 2", "Term 1"],
    sections: [
      {
  ...
  POSC210: {
    ...
    moduleCode: "POSC210",
    description:
      "This course analyzes in comparative perspective the relationships between states, governments, markets, international organizations and civil societies in the East and South East Asian regions.",
    credit: 1,
    terms: ["Term 2"],
    sections: [],
  },
  ...
  PSYC108: {
    ...
    moduleCode: "PSYC108",
    description:
      "This course gives an overview of the field which studies the behavior, thoughts and feelings of individuals in social contexts. The course will cover topics such as social cognition, social perception, social motivation, attitude formation and change, interpersonal dynamics, aggression and altruism, social influence and leadership, conformity, and antisocial behavior.",
    credit: 1,
    terms: ["Term 2", "Term 1"],
    sections: [
      {
  ...
  SOCG303: {
    ...
    moduleCode: "SOCG303",
    description:
      "This course investigates capitalism as the economic institution that creates our modern world. With a theoretical critic of this institution as the objective of this course, we will look at both the social-historical origin of capitalism and the embedded social contexts that eventually lead to the development of a variety of capitalisms in our contemporary world.",
    credit: 1,
    terms: ["Term 2"],
    sections: [],
    preReq: "SOCG001",
  ...
  TRAD201: {
    ...
    moduleCode: "TRAD201",
    description:
      "This course helps students to understand the elements common to all sectors of Shipping. In particular, students will see the interaction between the various players involved in the shipment process. This course will help students to understand the general process involved in the shipment of goods. Students interested in a career in Trade or Shipping may consider taking this course.",
    credit: 1,
    terms: ["Term 2", "Term 1"],
    sections: [
      {
  ...
  COR2626: {
    name: "Imagining the Self: Literature, Ethnicity and Gender in Asia",
    moduleCode: "COR2626",
    sections: [
      {
        code: "G1",
  ...
  "COR-GA2634": {
    name: "GA2634 - Exploring Asian Identities",
    moduleCode: "COR-GA2634",
    sections: [
      {
        code: "G1",
        professor: {
  ...
  "COR-SOCG2609": {
    name: "SOCG2609 - Global and Transnational Sociology",
    moduleCode: "COR-SOCG2609",
    sections: [
      {
        code: "G1",
        professor: {
  ...
  ECON240: {
    name: "Family and the Society: Economic Theories and Practices",
    moduleCode: "ECON240",
    sections: [
      {
        code: "G1",
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "THAM, TZE MINN MANDY, ERIC YEE SHIN CHONG",
        },
        location: {
          building: "LKCSB",
          room: "Seminar Room 3-5",
  ...
  FNCE318: {
    name: "Sustainable Finance Instruments",
    moduleCode: "FNCE318",
    sections: [
      {
        code: "G1",
  ...
  FNCE321: {
    name: "Carbon Markets and Products",
    moduleCode: "FNCE321",
    sections: [
      {
        code: "G1",
  ...
  IDIS201: {
    name: "Overseas Project Experience (Sustainability Communication in Asia)",
    moduleCode: "IDIS201",
    sections: [
      {
        code: "G1",
    ...
    credit: 1,
    description:
      "This SMU-X overseas course integrates academic learning with experiential projects provided by international organizations. It challenges students to apply their disciplinary knowledge and skills to real-world problems through interdisciplinary methods. The course collaborates with corporate, non-profit, and government-sector organizations abroad for project design and content delivery. Students will receive mentorship from both faculty and practitioners of these partner organizations, guiding them to develop practical and implementable solutions. Although the course demands significant effort and time from students, its journey and outcomes can be highly rewarding. All SMU-XO courses meet the Global Exposure requirement. With a focus on project-based experiential learning and cross-cultural understanding, SMU-XO courses aim to: • Enhance awareness of interdisciplinary connections and differences, encouraging knowledge integration to address issues or challenges. • Foster a deeper understanding of business opportunities and challenges in various global markets and economies relevant to students' interests. • Familiarize students with informal networks and emphasize leveraging SMU-related networks in a global context. • Provide global exposure to cultivate culturally sensitive global citizens. • Encourage adaptation to new environments and leadership development. • Promote creative and critical problem-solving skills. • Support sound decision-making in complex situations. • Enhance collaborative and productive teamwork. This course focuses on Southeast Asia, but may include South Asia, East Asia, and Oceania. The partner organization will have a need for strategic planning and communication, whether they have never conducted such planning or need to update an existing plan. In addressing that need, students will develop a communication strategy within the social marketing and strategic communication frameworks based on fieldwork in the host community. The first half of the semester involves lectures about key issues in sustainable development, social marketing, and strategic communication. It also involves discussions with representatives from the partner organization, partner organisations, and communication practitioners who can guide preparation for the fieldwork. During recess week, and with the support of the partner organisation, students will interview, document, and observe members of the host community as part of formative research in formulating a communication strategy. This immersive experience will provide students with new perspectives on some of the challenges facing people and the planet. It will be an opportunity to put theory into practice and, hopefully, have a positive impact in the world. In the second half of the semester, students will refine their communication strategies and develop communication collaterals. They will also reflect on the long-term sustainability of the strategy and how to evaluate its effectiveness. The semester ends with the presentation of the communication strategy before a panel composed of the course instructor and representatives from the partner organisation and other interested individuals.",
    terms: ["Term 1"],
  },
  INTS202: {
    name: "Creating Integrative Solutioning through Projects (CIS Projects)",
    moduleCode: "INTS202",
    sections: [
      {
        code: "G1",
        professor: {
          name: "FIONA CLARE WILLIAMSON, MAARTJE DE VISSER",
        },
        location: {
          building: "YPHSL",
          room: "Seminar Room 2-01",
  ...
  IS423: {
    name: "Financial Markets Processes and Technology",
    moduleCode: "IS423",
    sections: [
      {
        code: "G1",
...
`,
  ...
  IS434: {
    ...
    terms: ["Term 1"],
    preReq: {
      or: ["IS111", "IS115", "CS101", "COR-IS1702", "COR-IS1704"],
    },
  },
  IS445: {
    name: "Corporate Banking Technology",
    moduleCode: "IS445",
    sections: [
      {
        code: "G1",
        professor: {
          name: "RAMAPRASAD RAMAKRISHNAN",
        },
        location: {
          building: "SCIS1",
          room: "Seminar Room 3-1",
  ...
  IS468: {
    name: "Sustainable Digital Cities",
    moduleCode: "IS468",
    sections: [
      {
        code: "G1",
    ...
    terms: ["Term 1"],
    mutuallyExclusive: ["IS468", "SMT112"],
  },
  IS469: {
    name: "Generative AI with LLMs: From Development to Applications",
    moduleCode: "IS469",
    sections: [
      {
        code: "G1",
  ...
  IS470: {
    name: "Guided Research in Computing",
    moduleCode: "IS470",
    sections: [
      {
        code: "G1",
  ...
  IS471: {
    name: "Guided Research in Computing 2",
    moduleCode: "IS471",
    sections: [
      {
        code: "G1",
  ...
  IS472: {
    name: "Guided Advanced Research in Computing",
    moduleCode: "IS472",
    sections: [
      {
        code: "G1",
  ...
  IS485: {
    name: "IS/SMT/C&L Project Experience (Research)",
    moduleCode: "IS485",
    sections: [
      {
        code: "G1",
  ...
  LAW108_608: {
    name: "The Singapore Legal System",
    moduleCode: "LAW108_608",
    sections: [
      {
        code: "G1",
        professor: {
  ...
  LAW301_631: {
    name: "Legal Theory & Philosophy",
    moduleCode: "LAW301_631",
    sections: [
      {
        code: "G1",
        professor: {
  ...
  LAW4012: {
    name: "Entrepreneurship in Singapore - From Cradle To Grave",
    moduleCode: "LAW4012",
    sections: [
      {
        code: "G1",
  ...
  LAW4067: {
    name: "AI Literacy and Digital Innovation for Lawyers",
    moduleCode: "LAW4067",
    sections: [
      {
        code: "G1",
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "RENNIE WHANG, ERIK WIDJAJA, HO PEY YANN",
        },
        location: {
          building: "YPHSL",
          room: "Seminar Room 3-01",
  ...
  LAW4072: {
    name: "Foundations of Financial Crime Compliance",
    moduleCode: "LAW4072",
    sections: [
      {
        code: "G1",
  ...
  LAW4084: {
    ...
    credit: 1,
    description:
      "This course aims to introduce students to an understanding of how international law operates in practice. Viewed through the perspective of states’ experiences with public international law, including that of Singapore’s as a small state, this course will consider the operation of international law in key areas. The aim will be for students to critically inquire how the normative framework of international law is actualized by interrogating its application through a range of topics.",
    terms: ["Term 1"],
  },
  LAW414: {
    name: "International Commercialisation of Intellectual Property Rights",
    moduleCode: "LAW414",
    sections: [
      {
        code: "G1",
    ...
    preReq: {
      or: [
        {
          and: ["LAW101_601", "LAW102_602", "LAW105_605", "LAW202_622"],
        },
        "LGST101",
      ],
    },
  ...
  LAW445: {
    name: "Principles of the Law of Restitution",
    moduleCode: "LAW445",
    sections: [
      {
        code: "G1",
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "NANDAKUMAR PONNIYA, NG KIM BENG",
        },
        location: {
          building: "YPHSL",
          room: "Seminar Room 3-12",
  ...
  LAW451: {
    name: "Pre-trial Practice in Civil Litigation",
    moduleCode: "LAW451",
    sections: [
      {
        code: "G1",
        professor: {
          name: "FRANK OH SHENG LOONG, LIONEL LEO, LIN CHUNLONG",
        },
        location: {
          building: "YPHSL",
          room: "Seminar Room 3-01",
  ...
  LAW478: {
    name: "Professional Mediation Skills",
    moduleCode: "LAW478",
    sections: [
      {
        code: "G1",
        professor: {
          name: "NADJA ALEXANDER",
        },
        location: {
          building: "SMUC",
          room: "Active Learning CR 3-2",
    ...
    credit: 1,
    description:
      "This course explores the various theories and practices of mediation. The stages of the mediation process and techniques for each stage are taught. Simulated role-play exercises are arranged to develop skills as mediators. This course aims to provide students with a strong grounding in problem-solving mediation, and the opportunity to develop practical skills as a facilitative mediator. After successfully completing this course students will be able to: 1) Explain facilitative mediation and the purpose of each stage in the process; 2) Explain the different approaches to mediation and when each might be appropriate; 3) Apply the skills and techniques in communication, negotiation and mediation. 4) Reflect meaningfully on the practical experience and analyze how the experience relates to conflict resolution theories. 5) Research and critically discuss some current issues in conflict resolution and effectively present (orally and in writing) your research findings.",
    terms: ["Term 1"],
    preReq: {
      or: [
        "LGST101",
  ...
  LAW481: {
    name: "International Mediation Law and Practice",
    moduleCode: "LAW481",
    sections: [
      {
        code: "G1",
    ...
    sections: [
      {
        code: "G1",
        professor: {
          name: "STEFAN MORKOETTER, MATTHIAS TIETZ",
        },
        location: {
          building: "LKCSB",
          room: "Seminar Room 2-2",
      ...
      },
      {
        code: "G2",
        professor: {
          name: "MATTHIAS TIETZ, STEFAN MORKOETTER",
        },
        location: {
          building: "LKCSB",
          room: "Seminar Room 2-2",
  ...
  MGMT233: {
    name: "Leadership Seminar with CEOs",
    moduleCode: "MGMT233",
    sections: [
      {
        code: "G1",
  ...
  OPIM322: {
    name: "High Performance Warehousing and Fulfillment",
    moduleCode: "OPIM322",
    sections: [
      {
        code: "G1",
  ...
  POSC225: {
    name: "Contemporary American Politics",
    moduleCode: "POSC225",
    sections: [
      {
        code: "G1",
  ...
  PPPM204: {
    name: "Political Participation and Policy",
    moduleCode: "PPPM204",
    sections: [
      {
        code: "G1",
  ...
  STAT311: {
    name: "Risk Theory and Loss Models",
    moduleCode: "STAT311",
    sections: [
      {
        code: "G1",
